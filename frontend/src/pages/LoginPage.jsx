      ...
      <div className="h-[85dvh] text-zinc-200 flex flex-col items-center justify-center">
        ...
        <div>
          ...
          <form action="" className="flex flex-col items-center">
            <div className="flex items-center my-4 bg-zinc-700 px-16 py-4 rounded-full">
            ...
            <button type="submit" className="my-4 bg-zinc-800 px-8 py-4">
              Login
            </button>
          </form>

          <p className="mt-20 text-center">Don't have an account? Register!</p>
        </div>
      </div>
    </>
  );
